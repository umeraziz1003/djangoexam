...
urlpatterns = [
    ...
    path("template/", views.enrollments_template_download, name="enrollments_template"),
    path("bulk/preview/", views.enrollments_bulk_preview, name="enrollments_bulk_preview"),
    path("bulk/commit/", views.enrollments_bulk_commit, name="enrollments_bulk_commit"),
