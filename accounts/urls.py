...
urlpatterns = [
    ...
    path("users/template/", views.users_template_download, name="users_template"),
    path("users/bulk/preview/", views.users_bulk_preview, name="users_bulk_preview"),
    path("users/bulk/commit/", views.users_bulk_commit, name="users_bulk_commit"),
